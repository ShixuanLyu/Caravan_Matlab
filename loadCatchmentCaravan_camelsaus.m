...
%    for Caravan_camelsaus format.
%
%   INPUT
%   ID: catchment ID in Caravan_camelsaus
...
file_ID = strcat(path, 'camelsaus_',num2str(ID),'.csv');
